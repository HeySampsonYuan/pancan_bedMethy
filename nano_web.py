...
if option2 == 'bed file':
    ...
    if uploaded_file != None and len(uploaded_file)==2:
        ...
        data_containers = methylprep.run_pipeline('tempDir/', export=False,betas=True,array_type=None, manifest_filepath=None, sample_sheet_filepath='tempDir/samplesheet.csv', sample_names=None)
