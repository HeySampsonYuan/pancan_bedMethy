...
if option2 == 'bed file':
    ...
    if uploaded_file != None and len(uploaded_file)==2:
        ...
        sample_sheet = methylprep.get_sample_sheet('tempDir/', filepath='tempDir/sample_sheet')

        data_containers = methylprep.run_pipeline('tempDir/', export=False,betas=True,array_type=None, manifest_filepath=None, sample_sheet_filepath='tempDir/sample_sheet', sample_names=None)
