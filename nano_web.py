...
def load_model(option1):
    if option1 == 'Pan-cancer_v5i':
        ...
        model_files = pickle.load(urlopen('https://charitede-my.sharepoint.com/:u:/g/personal/dongsheng_yuan_charite_de/ETnaFmBmdFxCnx4pygZJ4fkBUKUQ6v1lgMhTjkiESlrFsQ'))
    model = model_files[0]
    enc =  model_files[1]
